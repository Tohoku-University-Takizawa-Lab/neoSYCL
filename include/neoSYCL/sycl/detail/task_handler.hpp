...
namespace neosycl::sycl::detail {
  ...
  public:
    ...
    virtual void set_range(const char* name, range<1>& d) {}
    virtual void set_range(const char* name, range<2>& d) {}
    virtual void set_range(const char* name, range<3>& d) {}

    virtual void set_offset(const char* name, id<1>& i) {}
    virtual void set_offset(const char* name, id<2>& i) {}
    virtual void set_offset(const char* name, id<3>& i) {}
  };
