#ifndef SYCL_INCLUDE_CL_SYCL_NEC_VEOFFLOAD_DRIVER_HPP_
#define SYCL_INCLUDE_CL_SYCL_NEC_VEOFFLOAD_DRIVER_HPP_
...
#endif //SYCL_INCLUDE_CL_SYCL_NEC_VEOFFLOAD_DRIVER_HPP_
